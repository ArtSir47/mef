...
(function() {
    ...
    scriptCookie.src="https://mef.dev/styles/coocie.js";
    ...
    else if (langattr == 'en_US') {
        urlprivacy = '/en/privacy-policy.php';
    }
    else if (langattr == 'ru_RU') {
    ...
    googleCode.src = "https://mef.dev/styles/google.js";
